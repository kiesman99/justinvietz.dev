...
<Collapsible title="Preview">
    <video autoplay controls loop src={`${BASE}/blog/remixing-angular/long-loading.webm`}></video>
</Collapsible>
...
<Collapsible title="Preview">
    <video autoplay controls loop src={`${BASE}/blog/remixing-angular/loading-indicator.webm`}></video>
</Collapsible>
...
<Collapsible title="Preview">
    <video autoplay controls loop src={`${BASE}/blog/remixing-angular/reload.webm`}></video>
</Collapsible>
